...
# Installation
Clone this repo into ``ComfyUI/custom_nodes`` or use [ComfyUI-Manager](https://github.com/ltdrdata/ComfyUI-Manager)'s "Install via Git URL" option. (NOTE: Installing by name currently broken: https://github.com/ltdrdata/ComfyUI-Manager/pull/407).
